...
void Texture::SetTexture(const char* path)
{
	...
	if (data == NULL || (m_Width & (m_Width - 1) != 0) || (m_Height & (m_Height - 1) != 0)) __debugbreak(); //for optimization reasons, make sure all textures have a width and height that is a power of 2. eg. 8x8, 16x16, 64x64
